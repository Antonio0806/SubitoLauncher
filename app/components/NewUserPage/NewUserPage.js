      ...
      <Transition in={mounted} timeout={{ enter: 250, exit: 0 }} appear key="1">
        {state => (
          ...
          >
            ...
            >
              <h1 style={{ fontSize: 37 }}>{t('WelcomeToSubitoLauncher', 'Welcome to SubitoLauncher!')}</h1>
              <div style={{ display: 'flex' }}>
                <p style={{ fontSize: 25 }}>
                  {t('helloUser', `Hello ${props.username}!`)}<br />
                  {t('SubitoLauncherOpenSource', 'SubitoLauncher is free and open source, it wouldn\'t exist without its community and donations. If you find any bug or have any suggestion, tell us on Discord!')}
                  <br />
                  <br />
                ...
                <iframe
                  ...
                  src="https://discord.com/widget?id=934770916943085609&theme=dark"
                  width="350"
                  height="515"
