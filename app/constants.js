...
export const GDL_COMPANION_MOD_URL = 'http://santosubito.xyz/subitolauncher/depends/GDLCompanion.jar';
export const GDL_LEGACYJAVAFIXER_MOD_URL =
  'http://santosubito.xyz/subitolauncher/depends/legacyjavafixer-1.0.jar';
...
export const UPDATE_URL =
  'https://raw.githubusercontent.com/Antonio0806/SubitoLauncher/master/package.json';
export const THEMES = {
  default: {
    name: 'Default',
    primary: '#2980b9',
